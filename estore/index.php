            ...
            <div class="container">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <?php
                            $result =$lib-> selector("SELECT * FROM product_tb");
                            if($result !== false){ $no = 0; ?>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single-product mb-60">
                                            ...
                                            <div class="product-caption">
                                                ...
                                                <h4>
                                                    <a href="single-product.html"><?php echo $value['prodName'];?></a>
                                                </h4>

                                                <div class="price">
                                                    <ul>
                                                        <li>$<?php echo $value['prodPrice'];?></li>
                                                        <Br/>
                                                        <li class="quantity">
                                                            <p>Qty <?php echo $value['prodQty'];?></p>
